...
public class CustomerRateLimitGatewayFilterFactory extends AbstractGatewayFilterFactory<CustomerRateLimitGatewayFilterFactory.Config> {
    ...
    public CustomerRateLimitGatewayFilterFactory(RateLimiter defaultRateLimiter, KeyResolver defaultKeyResolver) {
        super(Config.class);
